...
architecture rtl of SDCARD is
	component Altera_UP_SD_Card_Avalon_Interface is
		port (
			i_avalon_chip_select : in    std_logic                     := 'X';             -- avalon_sdcard_slave.chipselect
			...
			b_SD_cmd             : inout std_logic                     := 'X';             --         conduit_end.export
...
begin
	...
	sdcard : component Altera_UP_SD_Card_Avalon_Interface
		port map (
...
end architecture rtl; -- of SDCARD
