    set sopc "f:/altera/91sp2/quartus//sopc_builder"
    set sopc_perl "f:/altera/91sp2/quartus//bin/perl"
...
alias s "vlib work;
_init_setup
vcom -93 -explicit F:/documents/doc/GitHub/systems-project-verilog/Altera_UP_SD_Card_Avalon_Interface_0.vhd
set StdArithNoWarnings 1
 
 
vlog +incdir+.. ../Auido_core_Controller.v;
_vsim;
do virtuals.do
; test_contents_files"
alias r "exec $sopc_perl/bin/perl -I $sopc/bin/perl_lib -I $sopc/bin $sopc/bin/run_command_in_unix_like_shell.pl $sopc { cd ../;  ./Auido_core_Controller_generation_script  } "
alias c "echo {Regenerating memory contents.
 (This may take a moment)...}; restart -f; exec $sopc_perl/bin/perl -I $sopc/bin/perl_lib -I $sopc/bin $sopc/bin/run_command_in_unix_like_shell.pl $sopc { cd ../;  ./Auido_core_Controller_generation_script  }  --software_only=1"
